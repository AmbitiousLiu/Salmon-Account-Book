...
public class BarChartManager {
    ...
    public BarChartManager(BarChart barChart,String s) {
        mBarChart = barChart;
     ...
     * 初始化LineChart
     */
    private void initBarChart(boolean isSlither,String s) {
        //背景颜色
        ...
        // 设置是否可以触摸
        mBarChart.setTouchEnabled(isSlither);
        // 是否可以拖拽
        ...
        mBarChart.setDoubleTapToZoomEnabled(true); // 设置为false以禁止通过在其上双击缩放图表。
